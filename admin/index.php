...
$query = "SELECT posts.id, title, category_id FROM posts WHERE author_id=$current_user_id ORDER BY id DESC";
    ...
    <div class=" container dashboard_container">
        ...
        <aside>
            <ul>
                ...
                <li>
                    <a href="index.php" class="active"><i class="uil
                                    uil-postcard"></i>
                        <h5>Manage Post</h5>
                    </a>
                </li>
                ...
                <li>
                    <a href="manage-categories.php"><i class="uil
                                    uil-list-ul"></i>
        ...
        <main>
            ...
            <table>
                ...
                <tbody>
                    ...
                    <!-- get Category title of each from categories table -->
                    <?php  
                    ...
                    <tr>
                        ...
                        <td><a href="<?= ROOT_URL ?>admin/delete-post.php?id=<?= $post['id']  ?>" class="btn
